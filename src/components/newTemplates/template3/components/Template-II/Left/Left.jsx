  ...
  return (
    <div style={{ background: state }} className="left-container">
      <div className="profile-div">
        <img className="universal" src={data?.personal?.profilePic} alt="" />
      </div>
      ...
      <section className="technical-section">
        ...
        <p style={{ color: color }} className="tech">
      ...
      <section className="interest-section">
        ...
        <p className="universal" style={{ color: color, fontSize: "11px" }}>
          {data?.interests?.join(" | ")}
        </p>
      </section>
      ...
      <section className="achievements-section">
        ...
        {data?.accomplishments?.map((ele) => {
          return (
            <li
              className="universal"
              style={{ color: color, lineHeight: "18px" }}
            >
              {ele}
            </li>
          );
