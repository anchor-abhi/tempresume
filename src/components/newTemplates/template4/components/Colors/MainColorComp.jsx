	...
	return (
		...
		>
			...
			>
				<ColorChanger
					defaultColor="#3b4358"
					handler={handleSColor}
					color={sColor}
					heading="Small Color Div"
				/>
				<ColorChanger
					defaultColor="#d0826f"
					handler={handleLColor}
					color={lColor}
					heading="Large Color Div"
				/>
				<ColorChanger
					defaultcolor="#000000"
					handler={handleHeadingColor}
					color={headingColor}
			...
			<Drawer
				...
				PageProps={{ sx: { width: "390", backgroundColor: "red" } }}
				anchor="right"
